...
void Window::CreateWindoww()
{
    ...
    ::RegisterClassExW(&wc);
    hwnd = ::CreateWindowW(wc.lpszClassName, L"RealityEngine", WS_OVERLAPPEDWINDOW, 100, 100, 1920, 1080, nullptr, nullptr, wc.hInstance, nullptr);

}

UINT Window::SetReSizeWidth(UINT width)
{
    g_ResizeWidth = width;
    return g_ResizeWidth;
}

UINT Window::SetReSizeHeight(UINT height)
{
